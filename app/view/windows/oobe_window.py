...
class WelcomePage(QWidget):
    ...
    def _initWidget(self) -> None:
        ...
        self.titleLabel = TitleLabel(self.tr("欢迎使用 Xenpai Kart Downloader"), self)
...
class BrowserExtensionPage(QWidget):
    ...
    def _initWidget(self) -> None:
        self.header = PageHeader(
            self.tr("安装浏览器扩展"),
            self.tr("让浏览器中的下载自动接管到 Xenpai Kart Downloader"), self,
        )
...
class AdvancedOptionsPage(QWidget):
    ...
    def _initWidget(self) -> None:
        ...
        self.aria2Card = OptionCard(
            ...
            self.tr("让支持 Aria2 的工具和网站把下载任务发给 Xenpai Kart Downloader"),
...
class CompletePage(QWidget):
    ...
    def _initWidget(self) -> None:
        ...
        self.descLabel = BodyLabel(
            self.tr("Xenpai Kart Downloader 已准备好为你工作。\n你可以随时在设置中调整所有选项。"),
            self,
        )
...
class OobeWindow(FluentWidget):
    ...
    def _initWidget(self) -> None:
        ...
        self.setWindowTitle("Xenpai Kart Downloader")
