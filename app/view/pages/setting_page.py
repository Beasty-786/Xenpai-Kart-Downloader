...
class SettingPage(ScrollArea):
    ...
    def _initCards(self) -> None:
        ...
        self.urlSchemeCard = SwitchSettingCard(
            ...
            self.tr("注册 xenpaikartdownloader:// 协议，允许浏览器扩展启动桌面端"),
        ...
        self.autoRunCard = SwitchSettingCard(
            ...
            self.tr("在系统启动时静默运行 Xenpai Kart Downloader"),
        ...
        self.feedbackCard = PrimaryPushSettingCard(
            ...
            self.tr("提供反馈"),
            self.tr("通过提供反馈来帮助我们改进 Xenpai Kart Downloader，也可查看日志排查问题"),
        )
    ...
    def _onOpenLogClicked(self) -> None:
        ...
        revealInFolder(f"{APP_DATA_DIR}/XenpaiKartDownloader.log")
