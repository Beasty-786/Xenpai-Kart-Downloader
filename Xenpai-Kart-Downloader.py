...
logger.add(f"{APP_DATA_DIR}/XenpaiKartDownloader.log", rotation="512 KB")
...
def setupEnvironment():
    ...
    qconfig.set(qconfig.fontFamilies, ["Segoe UI"], save=True)
    ...
    logger.info("Xenpai Kart Downloader v{} launched", VERSION)
